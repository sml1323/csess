...
## 리뷰 확정 (2026-06-01, `/plan-eng-review`)
...
## Phase A 개선 + prior art 재프레이밍 (2026-06-01, `/deep-research` 후)

전체 리서치: [`docs/research/2026-06-01-tui-prior-art.md`](research/2026-06-01-tui-prior-art.md)
(21 소스 → 102 주장 → 25 적대적 검증, 23 confirmed). 아래는 그 결론과 그로 인한 Phase A 변경.
